...
import org.misha.semaphore.ProducerConsumer.BlockingQueueSemaphore;
...
public final class Main {
    ...
    public static void main(final String... args) {
        ...
        final org.misha.semaphore.Linker<Integer> linker = new org.misha.semaphore.Linker<Integer>(producer, consumer);
        linker.link();
    }
}
